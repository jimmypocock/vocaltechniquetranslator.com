...
"[project]/lib/data/exception-words.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/data/phonetic-patterns.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, z: __turbopack_require_stub__ } = __turbopack_context__;
{
__turbopack_esm__({
    "consonantRules": (()=>consonantRules),
    "initialClusters": (()=>initialClusters),
    "morphemePatterns": (()=>morphemePatterns),
    "phoneticPatterns": (()=>phoneticPatterns),
    "silentPatterns": (()=>silentPatterns),
    "vowelPatterns": (()=>vowelPatterns),
    "vowelPhonemes": (()=>vowelPhonemes)
});
const vowelPhonemes = {
    // Monophthongs
    'i': {
...
"[project]/lib/vocal-translator.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, z: __turbopack_require_stub__ } = __turbopack_context__;
{
__turbopack_esm__({
    "VocalTranslator": (()=>VocalTranslator)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$exception$2d$words$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/data/exception-words.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/data/phonetic-patterns.ts [app-ssr] (ecmascript)");
;
;
class VocalTranslator {
    ...
    syllabify(word) {
        ...
        if (vowelPositions.length <= 1) return [
            word
        ];
        const syllables = [];
        let start = 0;
    ...
    analyzeMorphology(word) {
        ...
        // Check for prefixes
        for (const prefix of Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["morphemePatterns"].prefixes)){
        ...
        for (const suffix of Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["morphemePatterns"].suffixes)){
    ...
    normalizePhonetics(word, intensity) {
        if (!word) return '';
        ...
        for (const [cluster, transformations] of Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["initialClusters"])){
        ...
        for (const [pattern, transformations] of Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["phoneticPatterns"])){
            try {
        ...
        for (const [pattern, replacement] of Object.entries(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["silentPatterns"])){
            try {
                normalized = normalized.replace(new RegExp(pattern, 'g'), replacement);
            } catch  {
                continue;
    ...
    transformConsonantInContext(consonant, position, syllables, syllableIndex, positionInSyllable) {
        if (!consonant || !__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["consonantRules"][consonant]) {
            return consonant; // Return unchanged if no rule exists
        }
        const rules = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["consonantRules"][consonant];
        ...
        const transformation = contextRules;
    ...
    transformVowelPhoneme(vowelPattern, intensity) {
        ...
        try {
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vowelPatterns"][vowelPattern]) {
                const phoneticInfo = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vowelPatterns"][vowelPattern];
                const phoneme = phoneticInfo.sound;
                if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vowelPhonemes"][phoneme]) {
                    const transform = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vowelPhonemes"][phoneme];
                    return transform[level] || transform[1] || vowelPattern;
                }
            }
            // Fallback to single vowel
            if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vowelPhonemes"][vowelPattern]) {
                const transform = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vowelPhonemes"][vowelPattern];
                return transform[level] || transform[1] || vowelPattern;
            }
            ...
            for(let syllableIndex = 0; syllableIndex < syllables.length; syllableIndex++){
                ...
                while(i < syllable.length){
                    ...
                    if (i + 2 < syllable.length) {
                        ...
                        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vowelPatterns"] && __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vowelPatterns"][threeChar]) {
                    ...
                    if (!processed && i + 1 < syllable.length) {
                        ...
                        if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vowelPatterns"] && __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["vowelPatterns"][twoChar]) {
                    ...
                    if (!processed) {
                        if ('aeiouAEIOU'.includes(char)) {
                            ...
                            if (prevChar && 'bcdfghjklmnpqrstvwxz'.includes(prevChar.toLowerCase()) || i === syllable.length - 1 || nextChar && 'bcdfghjklmnpqrstvwxz'.includes(nextChar.toLowerCase())) {
                            ...
                            const transformed = this.transformConsonantInContext(char.toLowerCase(), i, syllables, syllableIndex, syllableResult.length);
    ...
    translateWord(word, intensity) {
        ...
        try {
            ...
            if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$exception$2d$words$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["exceptionWords"] && __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$exception$2d$words$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["exceptionWords"][originalWord]) {
                const level = this.getIntensityLevel(intensity);
                const exception = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$exception$2d$words$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["exceptionWords"][originalWord];
            ...
            if (morphology.prefix) {
                const prefixPattern = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["morphemePatterns"].prefixes[morphology.prefix.toLowerCase()];
                if (prefixPattern) {
                    const level = this.getIntensityLevel(intensity);
            ...
            if (morphology.suffix) {
                const suffixPattern = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$data$2f$phonetic$2d$patterns$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["morphemePatterns"].suffixes[morphology.suffix.toLowerCase()];
                if (suffixPattern) {
                    const level = this.getIntensityLevel(intensity);
    ...
    translateLyrics(lyrics, intensity) {
        ...
        const translatedLines = lines.map((line)=>{
            ...
            const processedLine = line.replace(/you'll/gi, 'youll') // Handle contractions
            .replace(/we'll/gi, 'well').replace(/i'll/gi, 'ill').replace(/can't/gi, 'cant').replace(/won't/gi, 'wont').replace(/don't/gi, 'dont').replace(/didn't/gi, 'didnt').replace(/wouldn't/gi, 'wouldnt').replace(/couldn't/gi, 'couldnt').replace(/shouldn't/gi, 'shouldnt').replace(/must've/gi, 'mustve').replace(/would've/gi, 'wouldve').replace(/could've/gi, 'couldve').replace(/should've/gi, 'shouldve');
...
"[project]/components/IntensitySlider.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, z: __turbopack_require_stub__ } = __turbopack_context__;
{
__turbopack_esm__({
    "default": (()=>IntensitySlider)
});
...
function IntensitySlider({ value, onChange }) {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "jsx-d4b9cb58313d374a" + " " + "intensity-control flex items-center gap-2.5",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                htmlFor: "intensity",
                className: "jsx-d4b9cb58313d374a" + " " + "font-semibold text-gray-800",
                children: "Intensity:"
            }, void 0, false, {
                fileName: "[project]/components/IntensitySlider.tsx",
                lineNumber: 17,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                ...
                className: "jsx-d4b9cb58313d374a" + " " + "intensity-slider"
            }, void 0, false, {
                fileName: "[project]/components/IntensitySlider.tsx",
                lineNumber: 20,
                columnNumber: 7
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                className: "jsx-d4b9cb58313d374a" + " " + "intensity-value font-bold text-[#667eea] text-xl min-w-[20px]",
                children: value
            }, void 0, false, {
                fileName: "[project]/components/IntensitySlider.tsx",
                lineNumber: 29,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$styled$2d$jsx$2f$style$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                id: "d4b9cb58313d374a",
                children: ".intensity-slider.jsx-d4b9cb58313d374a{appearance:none;background:#ddd;border-radius:3px;outline:none;width:200px;height:6px}.intensity-slider.jsx-d4b9cb58313d374a::-webkit-slider-thumb{appearance:none;cursor:pointer;background:#667eea;border-radius:50%;width:20px;height:20px}.intensity-slider.jsx-d4b9cb58313d374a::-moz-range-thumb{cursor:pointer;background:#667eea;border:none;border-radius:50%;width:20px;height:20px}"
...
"[project]/components/TechniqueInfo.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, z: __turbopack_require_stub__ } = __turbopack_context__;
{
__turbopack_esm__({
    "default": (()=>TechniqueInfo)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
;
function TechniqueInfo() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "technique-info bg-[#e3f2fd] p-4 rounded-lg mb-5 border-l-4 border-[#2196f3]",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                className: "text-[#1976d2] mb-2.5 font-semibold text-lg",
                children: "Balanced Vocal Technique & Readability"
            }, void 0, false, {
                fileName: "[project]/components/TechniqueInfo.tsx",
                lineNumber: 13,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                className: "list-none pl-0",
                children: techniques.map((technique, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
...
"[project]/components/Examples.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function Examples() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "examples mt-7 pt-5 border-t-2 border-gray-200",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "section-title text-xl font-semibold text-gray-800 mb-2.5",
                children: "Improved Readability Examples"
            }, void 0, false, {
                fileName: "[project]/components/Examples.tsx",
                lineNumber: 28,
                columnNumber: 7
            }, this),
            examples.map((example, index)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "example-title font-semibold text-gray-800 mb-1",
...
"[project]/components/VocalTranslatorApp.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, z: __turbopack_require_stub__ } = __turbopack_context__;
{
__turbopack_esm__({
    "default": (()=>VocalTranslatorApp)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vocal$2d$translator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/lib/vocal-translator.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$IntensitySlider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/components/IntensitySlider.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$TechniqueInfo$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/components/TechniqueInfo.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Examples$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/components/Examples.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
;
;
function VocalTranslatorApp() {
    const [intensity, setIntensity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(8);
    const [inputLyrics, setInputLyrics] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const [outputLyrics, setOutputLyrics] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const [translator] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(()=>new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$vocal$2d$translator$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["VocalTranslator"]());
    const translateLyrics = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(()=>{
        if (!inputLyrics.trim()) {
            setOutputLyrics('');
            return;
        }
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "container bg-white/95 rounded-[20px] p-[30px] shadow-[0_20px_40px_rgba(0,0,0,0.1)] backdrop-blur-[10px] w-full max-w-[1000px]",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "header text-center mb-[30px]",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        className: "text-[#333] text-[2.5em] mb-[10px] bg-gradient-to-r from-[#667eea] to-[#764ba2] bg-clip-text text-transparent",
                        children: "🎵 Vocal Technique Translator"
                    }, void 0, false, {
                        fileName: "[project]/components/VocalTranslatorApp.tsx",
                        lineNumber: 39,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-[#666] text-[1.1em]",
                        children: "Transform lyrics for optimal vocal technique and open throat positioning"
                    }, void 0, false, {
                        fileName: "[project]/components/VocalTranslatorApp.tsx",
                        lineNumber: 42,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$TechniqueInfo$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/components/VocalTranslatorApp.tsx",
                lineNumber: 47,
                columnNumber: 7
            }, this),
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "controls flex gap-5 mb-5 items-center flex-wrap",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$IntensitySlider$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                    value: intensity,
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "input-section mb-5",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "section-title text-[1.2em] font-semibold text-[#333] mb-[10px]",
                        children: "Original Lyrics"
                    }, void 0, false, {
                        fileName: "[project]/components/VocalTranslatorApp.tsx",
                        lineNumber: 54,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "output-section mb-5",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "section-title text-[1.2em] font-semibold text-[#333] mb-[10px]",
                        children: "Translated for Vocal Technique"
                    }, void 0, false, {
                        fileName: "[project]/components/VocalTranslatorApp.tsx",
                        lineNumber: 67,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Examples$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
                fileName: "[project]/components/VocalTranslatorApp.tsx",
                lineNumber: 79,
                columnNumber: 7
            }, this)
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__aa58b6._.js.map